    ...
    <div class="card-image">
      <NuxtLink :to="localePath({ name: 'escort-slug', params: { slug: escort.slug }})">
        ...
        <div class="card-content is-overlay ltr-is-top-right">
          ...
          <span class="tag is-success is-hidden-tablet ltr-is-smaller-top-right">{{ $numberWithDots(escort.rate) }} {{ $t('index.PYG') }}</span>
        </div>
        ...
        <div v-if="!isArea" class="card-content is-overlay ltr-is-bottom-right">
          ...
          <span class="tag is-success is-hidden-tablet ltr-is-smaller-bottom-right is-capitalized">{{ escort.area }}</span>
        </div>
      </NuxtLink>
    </div>
